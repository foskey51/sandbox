...
const Hero = () => {
    ...
    return (
        <div>
            {/* Entire Page Wrapper */}
            <div className="w-screen text-black dark:text-white transition-colors duration-500">
                ...
                <section className="relative min-h-screen flex items-center justify-center text-center px-4 sm:px-6 bg-gradient-to-t from-gray-50 to-gray-50 dark:from-gray-900 dark:to-black">
                    <div className="flex flex-col space-y-6 max-w-3xl w-full">
                        <h1 className="font-semibold text-3xl fsm:text-4xl md:text-5xl leading-relaxed sm:leading-tight">
                ...
                {/* Section 2: Features */}
                <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 bg-white dark:bg-gray-800 transition-colors duration-500">
                    <div className="max-w-3xl text-center space-y-6">
                        <h2 className="text-2xl sm:text-3xl font-semibold">What You Can Do</h2>
                        <ul className="space-y-4 text-gray-700 dark:text-gray-300">
                            <li>✨ Write and run JavaScript, Python, or Bash</li>
                            <li>🌐 Build full-stack apps in the browser</li>
                            <li>🧪 Experiment with real-time coding environments</li>
                        </ul>
                    </div>
                </section>

                {/* Section 3: Call to Action */}
                <section className="min-h-screen flex items-center justify-center bg-yellow-600 text-white px-4 sm:px-6 transition-colors duration-500">
                    <div className="max-w-2xl text-center space-y-6">
                        <h2 className="text-3xl sm:text-4xl font-bold">Ready to Dive In?</h2>
                        <p className="text-lg">Create, test, and build—all in one place. No setup required.</p>
                        <button className="bg-black hover:bg-gray-900 text-white px-6 py-3 rounded transition">
                            Launch the Sandbox
                        </button>
                    </div>
                </section>
                ...
                {/* Footer */}
                <footer className="py-6 text-center bg-gray-100 dark:bg-gray-900 text-sm text-gray-600 dark:text-gray-400">
